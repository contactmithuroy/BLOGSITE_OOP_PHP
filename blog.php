<?php include 'header.php'; 
    $blogObj = new Database();
    $blogObj->select('post','*','','','post_date','10');
    $getBlogResult = $blogObj->getResult();
?>
<div id="main-content">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    <?php foreach($getBlogResult as list('id'=>$id,'title'=>$postTitle,'post_date'=>$postDate,'details1'=>$details1,'details2'=>$details2,'blog_image'=>$blogImage)){ ?>
